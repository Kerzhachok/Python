...
# 29. Создать переменную currency_converter со значением item_2

currency_converter = item_2

# 30. Сделать if в котором будет условие: если currency_converter, то выполнять следующие шаги задания, иначе, вывести в консоль (“Переменная currency_convertor = ”, item_3)

if currency_converter:

# 31. Внутри if currency_converter сделать следующие If условия :
